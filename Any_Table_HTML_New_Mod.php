	   ...
	   function PrintArr()
	            {
	   	         ...
	   	         print "<tr>";
	   	         foreach ($this -> headers as $header)
                         print "<td align=\"center\" bgcolor=\"$this->bgcolor_h\"><font size=\"4pt\">&nbsp;$header&nbsp;</font></td>";
                 print "</tr>";
                 foreach ($this -> table_array as $row=>$cells)
                         {
                          print "<tr>"; 
        	              foreach ($cells as $elemnt){
                                       if ($element==='b') {print 'HELLOW';
        	                       print "<td align='center' bgcolor=\"$this->bgcolor_h\" >$elemnt</td>"; }
                                       else { print 'NO ANY HELLOW!';
